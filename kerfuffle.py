...
\033[1;36m    99. About\033[1;33m   100. Other Tools    0. Exit\033[1;m
    ...
    match menu:
            ...
            while True:
                ...
                match choose:
                    ...
                    case "both":
                        ...
                        break
                    case "number":
                        SPFnumber:str = input("what's the number (no dashes or parenthesis for the area code): ")
                        print("\033[1;35m\nbet \n")
            ...
            while True:
                ...
                match choose:
                    case "name":
                        ...
                        break
                    case "phone":
                        TPSnumber:str = input("put in their phone number: ")
                        print("\033[1;35m\nbet \n")
        ...
        case "98":
            ...
            if choose == "yes" or choose == "y":
                ALLnum:str = input("What is the person's number?: ")
